...
func RegisterGetProductController(api huma.API, repo Getter) {
	handler := NewGetProductHandler(repo)
...
func NewGetProductHandler(repo Getter) func(ctx context.Context, id uuid.UUID) (*ProductDTO, error) {
